                ...
                if(!user){
                    ...
                    User.findOne({_id:"5c007bd92275332a70bb109a"},(err,user)=>{
                        ...
                        if(!user){
                            ...
                            console.log(user.calender[req.body.month][req.body.datecondensed])

                            User.findOneAndUpdate({_id:"5c007bd92275332a70bb109a"}, {$set:{calender:user.calender}, $push:{bookings:req.body}},{new:true},(err,user)=>{

                                if(err)throw err;
                                if(!user){
                                    res.json({success: false, message:"User not found..."})
                                }else{
                                    //console.log(user.calander[req.body.month])
